        ...
        <form encType="multipart/form-data">
            <div className='row mr-1'>
                ...
                <div className="form-group col-12 row form-row">
                    ...
                    <div className="col-sm-auto mt-2">
                        <div className="form-check form-check-inline">
                            <input onChange={changePropertyInfo('available')} checked={available === true ? true : false} className="form-check-input" type="radio" name="available" id="availableyes" value="true" disabled />
                            <label className="form-check-label text-primary" htmlFor="availableyes">Yes</label>
                        </div>
                        <div className="form-check form-check-inline">
                            <input onChange={changePropertyInfo('available')} checked={available === false ? true : false} className="form-check-input" type="radio" name="available" id="availableno" value="false" disabled />
                ...
                <div className="form-group col-12 col-lg-6 row form-row">
                    ...
                    <div className="col-sm-9">
                        <input type="text" disabled className="form-control text-primary" id="id" value={moment(createdAt).format('MMMM Do YYYY, h:mm:ss a')} />
                    </div>
                </div>
                <div className="form-group col-12 col-lg-6 row form-row">
                    <label htmlFor="id" className="col-sm-3 col-form-label"><strong>Updated</strong></label>
                    <div className="col-sm-9">
                        <input type="text" disabled className="form-control text-primary" id="id" value={moment(updatedAt).format('MMMM Do YYYY, h:mm:ss a')} />
                    </div>
                </div>
